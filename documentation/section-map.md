...
Sections listed per page, in render order.
...
9. EventsSection
10. ContactSection
11. NewsletterCTASection

## About (`about.astro`)

1. AboutHeroSection
2. BoolInNumbersSection
3. PowerAISection
4. FeaturedTechSection
5. TeamGridSection
6. FromPortugalSection
7. ContactSection
...
1. PortfolioHeroSection
2. CaseStudyGridSection
3. TestimonialsCarouselSection
4. PortfolioStatsSection
5. CertificationsSection
6. ClientLogosSection
7. LetsBuildCTASection
8. ContactSection
9. NewsletterCTASection
...
6. EventsCalendarSection
7. InsightsCTASection
8. ContactSection
9. NewsletterCTASection
