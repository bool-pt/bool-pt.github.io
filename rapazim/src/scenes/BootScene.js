...
class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.bitmapFont('carrier_command', 'https://www.bool.pt/assets/carrier_command.png', 'https://www.bool.pt/assets/carrier_command.xml');
        ...
        // Load rain
        this.load.image('background-rain', 'assets/images/rain.png');
        ...
        // Load BOOL flag
        this.load.image('boolFlag','assets/images/boolFlag.png');
    }
}
