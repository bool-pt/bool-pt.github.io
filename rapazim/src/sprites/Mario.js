export default class Mario extends Phaser.GameObjects.Sprite {
    ...
    update(keys, time, delta) {
        ...
        */
        ...
        this.scene.physics.add.collider(this, this.scene.groundLayer, this.scene.tileCollision);
    ...
    die() {
        ...
        // disable collisions to fall of the screen
    ...
    enterPipe(id, dir, init = true) {
        if (init) {
            ...
            this.scene.tweens.add({
                targets: this,
                //y: this.y + 40, // this was enabled, commented to fix entering pipes
                duration: 800, // 800 default value
                onComplete: function () {
            ...
            this.y = this.scene.destinations[id].top ? -100 : 150;
